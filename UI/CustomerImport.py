...
class Ui_CustomerWindow(object):
    ...
    def retranslateUi(self, CustomerWindow):
        ...
        self.treeWidget_cus_import.topLevelItem(0).setText(0, _translate("CustomerWindow", "1001"))
        self.treeWidget_cus_import.topLevelItem(0).setText(1, _translate("CustomerWindow", "Mr. A"))
        self.treeWidget_cus_import.topLevelItem(0).setText(2, _translate("CustomerWindow", "A@email.com"))
        self.treeWidget_cus_import.topLevelItem(0).setText(3, _translate("CustomerWindow", "01674561001"))
        self.treeWidget_cus_import.topLevelItem(0).setText(4, _translate("CustomerWindow", "Dhaka"))
        self.treeWidget_cus_import.topLevelItem(1).setText(0, _translate("CustomerWindow", "1002"))
        self.treeWidget_cus_import.topLevelItem(1).setText(1, _translate("CustomerWindow", "Mr. B"))
        self.treeWidget_cus_import.topLevelItem(1).setText(2, _translate("CustomerWindow", "B@email.com"))
        self.treeWidget_cus_import.topLevelItem(1).setText(3, _translate("CustomerWindow", "01673461002"))
        self.treeWidget_cus_import.topLevelItem(1).setText(4, _translate("CustomerWindow", "Dhaka"))
